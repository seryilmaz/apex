...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &multihead_attn::self_bias::cublas_gemmex::fwd, "Self Multihead Attention Forward.");
  m.def("backward", &multihead_attn::self_bias::cublas_gemmex::bwd, "Self Multihead Attention Backward.");
}
