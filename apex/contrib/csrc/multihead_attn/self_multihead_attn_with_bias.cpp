...
std::vector<torch::Tensor> fwd_cuda(
                               ...
                               torch::Tensor const& input_bias,
                               torch::Tensor const& output_bias,
...
std::vector<torch::Tensor> fwd(
                               ...
                               torch::Tensor const& output_weights,
                               torch::Tensor const& input_bias, torch::Tensor const& output_bias,
...
} // end namespace self_with_bias
} // end namespace multihead_attn

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &multihead_attn::self_with_bias::cublas_gemmex::fwd, "Self Multihead Attention Forward.");
  m.def("backward", &multihead_attn::self_with_bias::cublas_gemmex::bwd, "Self Multihead Attention Backward.");
}
